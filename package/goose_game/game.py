...
IMAGES_PATH = "package\\goose_game\\Goose"  # папка с картинками анимации # TODO обережно зі шляхами
...
def create_bonus():
    ...
    bonus = pygame.image.load("package\\goose_game\\bonus.png").convert_alpha()
